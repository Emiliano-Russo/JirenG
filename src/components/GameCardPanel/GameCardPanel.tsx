...
export const GameCardPanel: React.FC<Props> = (props:Props) => {
  ...
  return (
    <div style={{  display:"flex",flexDirection:"column", width:"240px", height:"360px", margin:"10px", position:"relative"}}>
      <button onClick={() => setVisible(true)}  style={{position:"absolute", right:"-10px",top:"-10px", borderRadius:"20px", background:"black", color:"red", border:"0px"}} className="btnHover">X</button>
